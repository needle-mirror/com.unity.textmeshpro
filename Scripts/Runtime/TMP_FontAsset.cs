    ...
    public class TMP_FontAsset : TMP_Asset
    {
        ...
        internal void InitializeGlyphPaidAdjustmentRecordsLookupDictionary()
        {
            ...
            if (m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup == null)
                m_FontFeatureTable.m_GlyphPairAdjustmentRecordLookup = new Dictionary<uint, TMP_GlyphPairAdjustmentRecord>();
            else
        ...
        */
        ...
        internal void UpdateGlyphAdjustmentRecords()
        {
            ...
            // Get glyph pair adjustment records from font file.
                ...
                int recordCount;
                GlyphPairAdjustmentRecord[] pairAdjustmentRecords = FontEngine.GetGlyphPairAdjustmentRecords(m_GlyphIndexList, out recordCount);
            #endif
